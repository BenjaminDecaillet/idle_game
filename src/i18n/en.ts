...
export const en = {
  ...
  'ui.animationsOn': 'Animations on',
  'ui.animationsOff': 'Animations off',
  'ui.floatsOn': 'Floating numbers on',
  'ui.floatsOff': 'Floating numbers off',
  'ui.season.stable': 'Stable market',
  'ui.season.boom': 'Boom: {spec}',
  'ui.season.crunch': 'Crunch',
  'ui.season.recovery': 'Recovery',
  'ui.seasonTitle': 'Market season — changes in {time}',
  'ui.milestonesHint': 'Ownership milestones: desk and team counts grant stepped output bonuses.',
  'ui.milestoneDesks': 'Desks',
  'ui.milestoneTeam': 'Team',
  'ui.milestoneNext': '+{bonus}% at {step}',
  'ui.milestoneMaxed': 'All milestones reached',
  'ui.automationTitle': 'Automation',
  'ui.automationHint':
    'Earned through play (or unlocked early with VsCoin), then toggled per company. Automation keeps a cash reserve and a free worker, and never promotes anyone.',
  'ui.autoTrain': 'Auto-training',
  'ui.autoTrainDesc': 'Restarts training for anyone below their skill cap.',
  'ui.autoHire': 'Auto-hiring',
  'ui.autoHireDesc': 'Accepts an affordable candidate whenever a desk is free.',
  'ui.autoDesks': 'Auto-desks',
  'ui.autoDesksDesc': 'Buys desks that pay for themselves within 30 minutes.',
  'ui.autoOn': 'On',
  'ui.autoOff': 'Off',
  'ui.autoUnlocked': 'Automation unlocked!',
  'ui.recruiterTitle': 'Recruiting desk',
  'ui.recruiterLevel': 'Recruiters — level {level}',
  'ui.recruiterIdle': 'No recruiters yet: 3 candidates, refilled on demand.',
  'ui.recruiterStatus': 'Pool of {cap} candidates, a fresh one every {time}.',
  'ui.recruiterHired': 'Recruiting capacity expanded!',
  'ui.maxLevel': 'Maxed',
  'error.autoLocked': 'This automation is still locked.',
  'ui.scoutBtn': 'Scout {price}',
  'ui.scoutHint': 'Send a market-scouting expedition ({time}).',
  'ui.scoutingUnderway': 'Expedition underway…',
  'ui.scoutStarted': 'Expedition to {name} is on its way!',
  'ui.scoutFirstTitle': 'Scout this market first.',
  'ui.marketReport': 'Market report in hand — +{bonus}% global output.',
  'ui.marketReportBack': 'The {name} market report is in!',
  'error.alreadyScouted': 'This market is already scouted.',
  'error.expeditionRunning': 'An expedition is already on its way there.',
  'error.scoutFirst': 'Scout this market with an expedition first.',
  'ui.viralTitle': 'A post is going viral — catch it!',
  'ui.viralCaught': 'Viral surge! The orders are pouring in.',
  'ui.viralJackpot': 'Mega-viral! +1 VsCoin.',
  'ui.exitsTitle': 'Exits & Founder Points',
  'ui.exitsHint':
    'Every exit restarts the empire from the garage and banks Founder Points from your lifetime peaks (earnings, headcount, countries) — plus Reputation for an IPO. Waiting always banks more; exiting early is never a loss.',
  'ui.exitAcq': 'Acquisition',
  'ui.exitAcqGate': 'Unlocks at {amount} lifetime earnings.',
  'ui.exitIpo': 'IPO',
  'ui.exitSpinoff': 'Conglomerate spin-off',
  'ui.exitSpinoffGate': 'Unlocks with {count} countries held at once.',
  'ui.exitBtn': 'Exit',
  'ui.founderBoardTitle': 'Founder perks',
  'ui.founderPoints': '{points} FP unspent',
  'ui.founderPointsLabel': 'Founder Points',
  'ui.respecBtn': 'Respec ({count} free)',
  'ui.respecConfirm': 'Refund every perk and get all Founder Points back?',
  'ui.respecDone': 'Perks refunded — reallocate your Founder Points.',
  'ui.perkBought': 'Founder perk acquired!',
  'perk.vision.name': 'Visionary Keynotes',
  'perk.vision.desc': '+5% output from all workers per level.',
  'perk.alumni.name': 'Alumni Network',
  'perk.alumni.desc': 'Training programs finish 10% faster per level.',
  'perk.lean-ops.name': 'Lean Operations',
  'perk.lean-ops.desc': 'All salaries cost 5% less per level.',
  'perk.cloud.name': 'Cloud Infrastructure',
  'perk.cloud.desc': 'Offline progress cap extended by 4 h per level.',
  'perk.war-chest.name': 'War Chest',
  'perk.war-chest.desc': 'Restart after an exit with a cash cushion.',
  'error.exitAcqLocked': 'Acquisition needs more lifetime earnings first.',
  'error.exitSpinoffLocked': 'A spin-off needs more countries held at once.',
  'error.exitNothingToBank': 'This exit would bank nothing yet — grow first.',
  'error.notEnoughFp': 'Not enough Founder Points.',
  'error.noPerks': 'No perks to respec.',
  'error.noRespec': 'No free respec available — one comes with every exit.',
