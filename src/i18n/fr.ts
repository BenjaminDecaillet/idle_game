...
export const fr: Record<keyof typeof en, string> = {
  ...
  'ui.exitsTitle': 'Sorties & Points Fondateur',
  'ui.exitsHint':
    'Chaque sortie relance l’empire depuis le garage et convertit vos records (gains, effectifs, pays) en Points Fondateur — plus de la Réputation pour une IPO. Attendre rapporte toujours plus ; sortir tôt n’est jamais une perte.',
  'ui.exitAcq': 'Acquisition',
  'ui.exitAcqGate': 'Se débloque à {amount} de gains cumulés.',
  'ui.exitIpo': 'IPO',
  'ui.exitSpinoff': 'Scission de conglomérat',
  'ui.exitSpinoffGate': 'Se débloque avec {count} pays détenus à la fois.',
  'ui.exitBtn': 'Sortir',
  'ui.founderBoardTitle': 'Atouts de fondateur',
  'ui.founderPoints': '{points} PF non dépensés',
  'ui.founderPointsLabel': 'Points Fondateur',
  'ui.respecBtn': 'Réattribuer ({count} gratuit)',
  'ui.respecConfirm': 'Rembourser tous les atouts et récupérer vos Points Fondateur ?',
  'ui.respecDone': 'Atouts remboursés — réattribuez vos Points Fondateur.',
  'ui.perkBought': 'Atout de fondateur acquis !',
  'perk.vision.name': 'Keynotes visionnaires',
  'perk.vision.desc': '+5% de production de tous les employés par niveau.',
  'perk.alumni.name': 'Réseau d’anciens',
  'perk.alumni.desc': 'Les formations finissent 10% plus vite par niveau.',
  'perk.lean-ops.name': 'Gestion frugale',
  'perk.lean-ops.desc': 'Tous les salaires coûtent 5% de moins par niveau.',
  'perk.cloud.name': 'Infrastructure cloud',
  'perk.cloud.desc': 'Plafond de progression hors ligne allongé de 4 h par niveau.',
  'perk.war-chest.name': 'Trésor de guerre',
  'perk.war-chest.desc': 'Redémarrez après une sortie avec un matelas de trésorerie.',
  'error.exitAcqLocked': 'L’acquisition demande d’abord plus de gains cumulés.',
  'error.exitSpinoffLocked': 'Une scission demande plus de pays détenus à la fois.',
  'error.exitNothingToBank': 'Cette sortie ne rapporterait rien pour l’instant — grandissez d’abord.',
  'error.notEnoughFp': 'Pas assez de Points Fondateur.',
  'error.noPerks': 'Aucun atout à réattribuer.',
  'error.noRespec': 'Pas de réattribution gratuite — chaque sortie en offre une.',
